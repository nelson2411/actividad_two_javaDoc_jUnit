package javabeans;
// Escribir una descripcion detallada de esta clase para generar un JavaDoc

/**
 * Esta clase implementará todos los métodos que están relacionados con la
 * multiplicación de la calculadora. Esta clase tendrá los siguientes métodos:
...
public class Producto {
	...
	/*
	 * Al ejecutar en la consola visualizaremos un menú con las opciones de los
	 * métodos que se pueden ejecutar.
